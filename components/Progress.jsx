...
export default function CalorisCard() {
  return (
    <div className="relative  rounded-3xl overflow-hidden p-6 px-8 border">
      {/* Background Image */}
      <div
        className="absolute inset-0 bg-cover bg-center opacity-40 animate-bounce mt-16"
      ...
      <div className="relative z-10 text-white">
        <h1 className="font-bold text-4xl text-center">Progress Tracking</h1>
        <p className="text-center text-sm pb-4">Visualize your fitness journey with detailed progress reports.</p>
