...
export default function WeightStep({ value, onChange, onNext, onBack }) {
  return (
      ...
      <div className="space-y-10">
        ...
        >
          ...
          <p className="text-lg text-gray-600 max-w-md mx-auto">
            This helps us track your fitness journey
          </p>
        </motion.div>
          ...
          <div className="relative space-y-8">
            <div className="flex items-center justify-center gap-6">
              <motion.input
                ...
                className="w-40 text-center text-7xl font-light bg-transparent border-b-2 border-gray-200 
                  focus:border-blue-500 focus:ring-0 placeholder-gray-300 transition-all"
              />
              <div className="flex flex-col items-start">
                <span className="text-4xl text-gray-400 font-light">kg</span>
                <span className="text-sm text-gray-400">kilograms</span>
              </div>
            </div>
            ...
            {value && (
              ...
              >
                <div className="w-3 bg-blue-100 rounded-full h-full relative">
                  <motion.div 
                    initial={{ height: '0%' }}
                    animate={{ height: `${Math.min((value / 120) * 100, 100)}%` }}
        ...
        >
          Healthy BMI weight range: 18.5-24.9 kg/m²
        </motion.div>
      </div>
    </div>
  )
